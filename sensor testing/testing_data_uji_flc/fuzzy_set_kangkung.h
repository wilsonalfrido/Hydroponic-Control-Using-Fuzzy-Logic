...
//FUZZY SET
  ...
  //OUTPUT  
    ...
    //Water pump
    FuzzySet *wp_Z = new FuzzySet(-20,1.25,1.25,22.5);
    FuzzySet *wp_S = new FuzzySet(22.5,43.75,43.75,65);
    FuzzySet *wp_M = new FuzzySet(65,86.25,86.25,107.5);
    FuzzySet *wp_LG = new FuzzySet(107.5,128.75,128.75,150);
