...
//  FuzzyRuleConsequent *ab_VVS_wp_Z = new FuzzyRuleConsequent();
  ...
  FuzzyRule *fuzzyRule10 = new FuzzyRule(10,ec_E_w_M,ab_S_wp_M);
...
//  FuzzyRuleConsequent *ab_Z_wp_Z = new FuzzyRuleConsequent();
  ...
  FuzzyRuleConsequent *ab_VVS_wp_LG = new FuzzyRuleConsequent();
  ab_VVS_wp_LG->addOutput(fuzzy_kangkung.ab_VVS);
  ab_VVS_wp_LG->addOutput(fuzzy_kangkung.wp_LG);

  FuzzyRule *fuzzyRule14 = new FuzzyRule(14,ec_H_w_M,ab_VVS_wp_LG);
