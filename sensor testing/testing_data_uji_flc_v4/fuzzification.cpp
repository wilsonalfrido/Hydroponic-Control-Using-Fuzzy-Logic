...
void fuzzy_rule(){
  ...
  FuzzyRuleConsequent *ab_M_wp_Z = new FuzzyRuleConsequent();
  ab_M_wp_Z->addOutput(fuzzy_kangkung.ab_M);
  ab_M_wp_Z->addOutput(fuzzy_kangkung.wp_Z);

  FuzzyRule *fuzzyRule3 = new FuzzyRule(3,ec_L_w_E,ab_M_wp_Z);
...
//  FuzzyRuleConsequent *ab_VS_wp_Z = new FuzzyRuleConsequent();
  ...
  FuzzyRule *fuzzyRule4 = new FuzzyRule(4,ec_L_w_H,ab_M_wp_Z);
  ...
  FuzzyRule *fuzzyRule5 = new FuzzyRule(5,ec_M_w_L,ab_VLG_wp_LG);
  ...
  FuzzyRule *fuzzyRule7 = new FuzzyRule(7,ec_M_w_E,ab_VS_wp_Z);
...
//  FuzzyRuleConsequent *ab_VVS_wp_Z = new FuzzyRuleConsequent();
  ...
  FuzzyRule *fuzzyRule8 = new FuzzyRule(8,ec_M_w_H,ab_VS_wp_Z);
  ...
  FuzzyRule *fuzzyRule9 = new FuzzyRule(9,ec_E_w_L,ab_LG_wp_LG);
  ...
  FuzzyRuleConsequent *ab_VVS_wp_M = new FuzzyRuleConsequent();
  ab_VVS_wp_M->addOutput(fuzzy_kangkung.ab_VVS);
  ab_VVS_wp_M->addOutput(fuzzy_kangkung.wp_M);

  FuzzyRule *fuzzyRule10 = new FuzzyRule(10,ec_E_w_M,ab_VVS_wp_M);
...
//  FuzzyRuleConsequent *ab_Z_wp_Z = new FuzzyRuleConsequent();
  ...
  FuzzyRuleConsequent *ab_M_wp_LG = new FuzzyRuleConsequent();
  ab_M_wp_LG->addOutput(fuzzy_kangkung.ab_M);
  ab_M_wp_LG->addOutput(fuzzy_kangkung.wp_LG);

  FuzzyRule *fuzzyRule13 = new FuzzyRule(13,ec_H_w_L,ab_M_wp_LG);
  ...
  FuzzyRuleConsequent *ab_Z_wp_M = new FuzzyRuleConsequent();
  ab_Z_wp_M->addOutput(fuzzy_kangkung.ab_Z);
  ab_Z_wp_M->addOutput(fuzzy_kangkung.wp_M);

  FuzzyRule *fuzzyRule14 = new FuzzyRule(14,ec_H_w_M,ab_Z_wp_M);
